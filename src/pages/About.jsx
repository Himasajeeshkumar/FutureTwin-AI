    ...
    return (
        ...
        <section className="about-section">
            ...
            <p className="about-description">
                FutureTwin combines Artificial Intelligence,
                resume analysis, career intelligence, and
                personalized mentoring into one platform
                that helps students become placement-ready
                with confidence.
            </p>
